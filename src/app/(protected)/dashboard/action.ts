...
export async function askQuestion(question: string, projectid: string) {
    ...
    (async () => {
        const { textStream } = await streamText({
            ...
            AI is a well-behaved dand well-mannered individual.
            ...
            If the context does not provide the answer to question, the AI will say, "I'm sorry, I don't know the answer to that question right now."
            AI assistant will not apologize for previous responses, but instead will indicated new information was gained.
            AI assistant will not invent anything that is not drawn directly from the context.
            Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering, make sure there is no ambiguity in your answer.
            `
        });
